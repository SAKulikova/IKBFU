...
//В данной задаче требуется ввести N точек своими координатами (x,y). Затем требуется определить,
...
void convexHull(std::vector<Point>& points)
{
    ...
    std::cout << "Вершины выпуклой оболочки:" << std::endl;
...
int main() {
    ...
    std::cout << "Введите координаты точек (x, y):" << std::endl;
    for (int i = 0; i < n; i++) {
