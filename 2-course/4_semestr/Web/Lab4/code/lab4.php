...
function addEntryToGoogleSheet($email, $title, $text, $category)
{
    ...
    $client->setAuthConfig('asshole-422217-d4b049133682.json');

    $service = new Google_Service_Sheets($client);
//https://docs.google.com/spreadsheets/d/1-BoGKWiss6rPPfPk0YVy1aFDAmU_EcWNEBI2ejTCRRY/edit#gid=0
    $spreadsheetId = '1-BoGKWiss6rPPfPk0YVy1aFDAmU_EcWNEBI2ejTCRRY/edit#gid=0';
